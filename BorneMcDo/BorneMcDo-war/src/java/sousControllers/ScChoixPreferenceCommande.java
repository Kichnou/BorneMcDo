...
public class ScChoixPreferenceCommande implements SousController {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        //DBG System.out.println("DBG Vous entrâtes dans ScChoixPreferenceCommande.execute : " + Instant.now().toString());
        ...
        if (request.getParameter("choix") != null) {
            ...
            if (request.getParameter("choix").equals("MangerSurPlace")) {           
                //DBG System.out.println("DBG Vous cliquâtes sur MangerSurPlace !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! " + Instant.now().toString());
    ...
    */        
                ...
                //DBG System.out.println("DBG Vous cliquâtes sur EmporterVotreCommande :-(..... " + Instant.now().toString());
                //FLCàfaire : affecter un attribut de session ?
    ...
    */        
        ...
        //DBG System.out.println("DBG Nous terminâmes l'exécution de ScChoixPreferenceCommande " + Instant.now().toString());   
        //DBG System.out.println("DBG À l'issue de l'exécution de ScChoixPreferenceCommande.execute, nous essayâmes de lancer ensuite url = <<" + url + ">>.");   
        return url;
