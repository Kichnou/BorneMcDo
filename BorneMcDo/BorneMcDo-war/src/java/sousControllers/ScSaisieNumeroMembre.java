...
public class ScSaisieNumeroMembre implements SousController {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        System.out.println("DBG Vous entrâtes dans ScSaisieNumeroMembre.execute : " + Instant.now().toString());
...
*/        
        ...
        System.out.println("DBG Vous saisissâtes le numéro de membre suivant : <<" + numeroMembreSaisi + ">>.");
        ...
        */
        if (numeroMembreSaisi.matches("[1-9]+[0-9]*")) {
            ...
            */
            ...
            if (clientQuiCommande != null) {
                ...
                //FLCàfaireAprèsPull@end : Information infoEnseigne = em.find(Information.class, "Enseigne");
                //FLCàfaireAprèsPull@end : Information infoNom = em.find(Information.class, "Nom");
                ...
                */
                ...
                //FLCàfaireAprèsPull@end : session.setAttribute("infoEnseigne",infoEnseigne.getDescription());
                //FLCàfaireAprèsPull@end : session.setAttribute("infoNom",infoNom.getDescription());
        ...
        System.out.println("DBG Nous terminâmes l'exécution de ScSaisieNumeroMembre " + Instant.now().toString());   
        System.out.println("DBG À l'issue de l'exécution de ScSaisieNumeroMembre.execute, nous essayâmes de lancer ensuite url = <<" + url + ">>.");   
        return url;
    }
