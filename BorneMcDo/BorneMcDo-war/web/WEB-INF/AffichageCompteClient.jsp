    ...
    <body class ="indentation">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col">
                    <c:url value="Controller?section=ScChoixPreferenceCommande" var="urlPasserUneCommande" />
                    <a class="btn btn-plein mx-auto" href="${urlPasserUneCommande}">Passer une commande</a>
                </div>
                <div class="col">
